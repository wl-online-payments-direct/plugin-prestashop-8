        ...
        <div class="row">
          ...
          <span>
            {l s='Delay before payment capture' mod='worldlineop'}
                        ...
                        <div class="col-lg-9">
                            <select name="worldlineopAdvancedSettings[paymentSettings][captureDelay]"
            ...
            <span class="switch prestashop-switch fixed-width-sm">
              ...
              <a class="slide-button btn"></a>
                ...
                <div class="js-worldlineop-payment-flow-modifications-settings-block">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3"
                               for="worldlineopAdvancedSettings[paymentSettings][successOrderStateId]">
            <span>
              {l s='Payment accepted status mapping' mod='worldlineop'}
            </span>
                        </label>
                        <div class="col-lg-9">
                            <select name="worldlineopAdvancedSettings[paymentSettings][successOrderStateId]"
            ...
            <span>
              {l s='Payment error status mapping' mod='worldlineop'}
                        ...
                        <div class="col-lg-9">
                            <select name="worldlineopAdvancedSettings[paymentSettings][errorOrderStateId]"
                                    class="fixed-width-xxl">
                                {foreach $data.extra.statuses as $status}
                                    <option value="{$status.id_order_state|intval}"
            ...
            <span>
              {l s='Pending payment status mapping' mod='worldlineop'}
                        ...
                        <div class="col-lg-9">
                            <select name="worldlineopAdvancedSettings[paymentSettings][pendingOrderStateId]"
                                    class="fixed-width-xxl">
                                {foreach $data.extra.statuses as $status}
                                    <option value="{$status.id_order_state|intval}"
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3"
                               for="worldlineopAdvancedSettings[paymentSettings][safetyDelay]">
          <span>
            {l s='Order validation safety delay' mod='worldlineop'}
          </span>
                        </label>
                        <div class="col-lg-9">
                            <select name="worldlineopAdvancedSettings[paymentSettings][safetyDelay]"
                                    class="fixed-width-md">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3"
                               for="worldlineopAdvancedSettings[paymentSettings][retentionHours]">
            <span>
              {l s='Release inventory from Pending payment orders after' mod='worldlineop'}
            </span>
                        </label>
                        <div class="col-lg-9">
                            <select name="worldlineopAdvancedSettings[paymentSettings][retentionHours]"
                                    class="fixed-width-md">
            ...
            <span class="switch prestashop-switch fixed-width-sm">
              ...
              <span class="switch prestashop-switch fixed-width-sm">
                ...
                <span class="label-tooltip"
                      data-toggle="tooltip"
                      data-html="true"
                      data-original-title="{l s='The No-Challenge Preference requests the card issuer
(and the customer’s card) not to apply Strong Customer Authentication (SCA). The issuer will approve or deny this request,
and the transaction will proceed accordingly. The Low-Value exemption applies to transactions below the defined threshold (30 EUR),
allowing these low-value payments to bypass SCA and speed up checkout. The Transaction Risk Analysis (TRA) exemption enables a dynamic risk assessment;
the issuer and your acquirer will evaluate risk factors, allowing transactions up to 100 EUR to qualify for exemption if deemed low risk.
Note that TRA typically requires a formal agreement with your acquirer; enable TRA only after such an agreement is in place.
Otherwise, all card transactions may be blocked. Choose carefully to balance user experience and security.' mod='worldlineop'}">
                  ...
                  <span class="js-worldlineop-select-3ds-exemption-type-button-text"
                    ...
                    {/if}
                                ...
                                <input type="hidden"
                                       name="worldlineopAdvancedSettings[threeDSExemptedType]"
                                       value="{$exType|escape:'htmlall':'UTF-8'}"
                            ...
                            <input type="hidden" id="databaseStoredExemptedValue"
                                   value="{$data.advancedSettings.threeDSExemptedValue|default:0|escape:'htmlall':'UTF-8'}"/>
                            <input type="hidden" id="databaseStoredExemptedType"
                                   value="{$data.advancedSettings.threeDSExemptedType|escape:'htmlall':'UTF-8'}"/>
                ...
                <span class="label-tooltip"
                  ...
                  {l s='Exemption limit' mod='worldlineop'}
                            ...
                            <div class="col-lg-9 col-lg-offset-3">
                                ...
                                <div id="js-worldlineop-select-3ds-exemption-limit-100"
                                     class="help-block wl-hidden-element">
                                    {l s='Please enter the amount limit (0 to 100 EUR).' mod='worldlineop'}
                                    <span></span>
                                </div>
                                <div id="js-worldlineop-select-3ds-exemption-limit-invalid-amount"
                                     class="help-block wl-hidden-element">
                                </div>
                            </div>
                        </div>
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-default pull-right js-worldlineop-submit-advanced-settings-form"
                    name="submitSaveAdvancedSettingsForm">
